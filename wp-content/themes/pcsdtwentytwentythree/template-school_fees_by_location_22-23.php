<?php
/*
		Template Name: School Fees - All Fees By Location 22-23
	*/
get_header();
?>
<main id="mainContent" class="sidebar">
		...
		<article id="activePost" class="activePost feePost noprior">
			...
			?>
				<ul>
					<li><a href="https://globalassets.provo.edu/fee-summary/22-23/fee_summary_<?php echo $location_of_fees_to_display['value']; ?>.pdf"><?php echo $location_of_fees_to_display['label']; ?> Fee Summary</a></li>
					</li>
				</ul>
			<?php
			}
				...
				?>
						<section class="feeDisplay feeBreakdown">
							...
							?>
								...
								<!--
										<article class="fee textright">
											<span><?php //echo $fee['prior_year_approved_fee']; 
													?></span>
										</article>
									-->
							<?php
			...
			$get_id_sql =  "SELECT post_id,meta_key,meta_value FROM psd_posts,psd_postmeta WHERE post_type = 'school_fees_22-23' AND psd_posts.ID = psd_postmeta.post_id AND meta_value = '" . $location_of_fees_to_display['value'] . "' ORDER BY post_title";
