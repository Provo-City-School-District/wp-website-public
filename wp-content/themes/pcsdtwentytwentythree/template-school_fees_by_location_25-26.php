<?php
/*
		Template Name: School Fees - All Fees By Location 25-26
	*/
get_header();
?>
<main id="mainContent" class="sidebar">
	...
	<div id="currentPage">
		<article id="activePost" class="activePost feePost noprior">
			...
			?>
				<ul>
					<li><a href="https://globalassets.provo.edu/fee-summary/25-26/fee_summary_<?php echo $location_of_fees_to_display['value']; ?>.pdf"><?php echo $location_of_fees_to_display['label']; ?> Fee Summary</a></li>
					</li>
				</ul>
			<?php
			}
			...
			$get_id_sql =  "SELECT post_id,meta_key,meta_value FROM psd_posts,psd_postmeta WHERE post_type = 'school_fees_25-26' AND psd_posts.ID = psd_postmeta.post_id AND meta_value = '" . $location_of_fees_to_display['value'] . "' ORDER BY post_title";
