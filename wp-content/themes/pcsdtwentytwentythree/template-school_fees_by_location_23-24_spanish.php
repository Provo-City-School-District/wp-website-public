<?php
/*
		Template Name: School Fees - All Fees By Location - Spanish - 23-24
	*/
get_header();
?>
<main id="mainContent" class="sidebar">
		...
		<article id="activePost" class="activePost feePost noprior">
			...
			?>
				<ul>
					<li><a href="https://globalassets.provo.edu/fee-summary/23-24/fee_summary_<?php echo $location_of_fees_to_display['value']; ?>_spanish.pdf"><?php echo $location_of_fees_to_display['label']; ?> resumen de tarifas</a></li>
					</li>
				</ul>
			<?php
			}
			...
			$get_id_sql =  "SELECT post_id,meta_key,meta_value FROM psd_posts,psd_postmeta WHERE post_type = 'pagos_escolares_2324' AND psd_posts.ID = psd_postmeta.post_id AND meta_value = '" . $location_of_fees_to_display['value'] . "' ORDER BY post_title";
