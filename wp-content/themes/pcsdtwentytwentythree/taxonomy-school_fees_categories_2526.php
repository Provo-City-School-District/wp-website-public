...
<main id="mainContent" class="sidebar">
	...
	<ol class="breadcrumbs" id="breadcrumbs">
		...
		<li><a href="https://provo.edu/school-fees-25-26/">School Fees 25-26</a> / </li>
	...
	<div id="currentPage">
		<article id="activePost" class="activePost">
			...
			$args = array(
				'post_type' => 'school_fees_25-26',
				'orderby' => 'title',
				'order' => 'ASC',
				'posts_per_page' => -1,
				'tax_query' => array(array('taxonomy' => 'school_fees_categories_2526', 'field' => 'name', 'terms' => $cat))
			);
