...
<main id="mainContent" class="sidebar">
	...
	<ol class="breadcrumbs" id="breadcrumbs">
		...
		<li><a href="https://provo.edu/school-fees-22-23/">School Fees 22-23</a> / </li>
	...
	<div id="currentPage">
		<article id="activePost" class="activePost">
			...
			$args = array(
				'post_type' => 'school_fees_22-23',
				'orderby' => 'title',
				'order' => 'ASC',
				'posts_per_page' => -1,
				'tax_query' => array(array('taxonomy' => 'school_fees_categories_2223', 'field' => 'name', 'terms' => $cat))
			);
