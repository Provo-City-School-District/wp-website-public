<?php
/*
Template Name: School Fees - All Fees By Location - Spanish - 21-22
	*/
get_header();
?>
<main id="mainContent" class="sidebar">
	...
	<div id="currentPage">
		<article id="activePost" class="activePost feePost">
			...
			?>
				<ul>
					<li><a href="https://globalassets.provo.edu/fee-summary/21-22/fee_summary_<?php echo $location_of_fees_to_display['value']; ?>_spanish.pdf"><?php echo $location_of_fees_to_display['label']; ?> resumen de tarifas</a></li>
					</li>
				</ul>
			<?php
			}
			...
			if (in_array($location_of_fees_to_display['value'], $middle_locations)) {
				...
				$middle_gen_fees = get_fields(59520);
			?>
			...
			if (in_array($location_of_fees_to_display['value'], $high_locations)) {
				...
				$high_gen_fees = get_fields(59694);
			...
			$get_id_sql =  "SELECT post_id,meta_key,meta_value FROM psd_posts,psd_postmeta WHERE post_type = 'pagos_escolares_2122' AND psd_posts.ID = psd_postmeta.post_id AND meta_value = '" . $location_of_fees_to_display['value'] . "' ORDER BY post_title";
